      ...
      <DialogContent className="sm:max-w-[400px]">
        <DialogHeader>
          ...
          <p className="text-sm text-muted-foreground">
            {mode === "signin"
              ? "Sign in to save your conversation history and access it from anywhere."
              : "Create a free account to save your chats and access them from any device."}
          </p>
        </DialogHeader>
        ...
        <div className="space-y-4 pt-2">
          ...
          <form onSubmit={handleEmailAuth} className="space-y-3">
            ...
            <Button
              type="submit"
              className="w-full bg-grundfos-blue hover:bg-grundfos-dark"
              disabled={loading}
            >
              {loading ? (
            ...
            {mode === "signin" ? (
              <>
                ...
                <button
                  ...
                  className="text-grundfos-blue hover:underline"
                >
                  Sign up free
                </button>
              </>
